...
**Where to read next:** step-by-step experiment procedures, split protocols, and CLI reference are in [`EXPERIMENTS.md`](EXPERIMENTS.md). **DRKG Slurm** (prepared cache, GPU sweep, extra method jobs, monitoring) is documented in [`scripts/slurm/README.md`](scripts/slurm/README.md).
